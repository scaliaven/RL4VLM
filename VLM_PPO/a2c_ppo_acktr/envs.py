...
def make_env(env_id, seed, rank, log_dir, allow_early_resets, use_cnn=False, feature_type="hold"):
    def _thunk():
...
def make_vec_envs(env_name,
                  ...
                  feature_type="hold"):
    envs = [
        make_env(env_name, seed, i, log_dir, allow_early_resets, use_cnn, feature_type)
